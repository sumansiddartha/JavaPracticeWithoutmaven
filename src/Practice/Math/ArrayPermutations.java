...
public class ArrayPermutations {
	...
	public static <T> void printAllIterative( T[] elements, char delimiter) {
		printAllIterative(elements.length,elements,delimiter);
	}
	...
	//permutations sorted by the natural order
	...
	public static void main(String[] args) {
		  ...
		  Integer[] elements = {1,2,3,4};
	        ...
	        printAllIterative(elements,'-');
	        System.out.println("sorted by the natural order:============");
